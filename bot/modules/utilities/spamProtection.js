...
module.exports.check = (user, command) => {
  return new Promise((resolve, reject) => {
    ...
    let AMOUNT_OF_COMMANDS = CLIENT_CONFIG.COMMAND_SPAM_PROTECTION.AMOUNT_OF_COMMANDS
    let AMOUNT_OF_SECONDS = CLIENT_CONFIG.COMMAND_SPAM_PROTECTION.AMOUNT_OF_SECONDS
