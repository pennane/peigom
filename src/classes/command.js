...
class Command {
  ...
  static adminAuthorized(msg) {
    return (config.DISCORD.AUTHORIZED.indexOf(msg.author.id) > -1 || msg.member.hasPermission('ADMINISTRATOR')) && true
  }

  static superAdminAuthorized(msg) {
    return (config.DISCORD.AUTHORIZED.indexOf(msg.author.id) > -1) | false
  }
