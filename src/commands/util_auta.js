  ...
  return new Promise((resolve, reject) => {
    ...
    function botInfoEmbed() {
      ...
      embed
        ...
        .addField(
          `:question: Mikä ihmeen ${config.APP.NAME} ?`,
          `${config.APP.NAME} on tälläne [node.js](https://nodejs.org/) discord botti, joka pistää röttöilijät kuriin.`
        )
    ...
    } else if (args[1].toLowerCase() === config.APP.NAME.toLowerCase()) {
