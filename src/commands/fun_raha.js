...
module.exports.executor = function (message, client, args) {
      ...
      case 'lahjoita': {
        ...
        if (!receiver) {
          let embed = new Discord.MessageEmbed()
            .setColor(0xf4e542)
            .setTitle(`Käyttäjä ${message.author.username}, huomaa:`)
            .setDescription(`Lahjoituksesi vastaanottajaa ei kiinnosta rahat. Houkuttele hänet ensin uhkapelaamaan.`)
          message.channel.send(embed)
          return
        }
        ...
        let embed = new Discord.MessageEmbed()
          .setColor(0xf4e542)
          .setTitle(`${message.member.user.username}, huomaa:`)
